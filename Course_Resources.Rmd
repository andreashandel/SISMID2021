...
This page lists resources that are relevant for this course.
...
* There are many further resources available for learning more. We list some of them in the [Resources section of the SMI course website]().

For a list of terms that are commonly used in Immunology and Modeling see [this Glossary on the SMI website](https://andreashandel.github.io/SMIcourse/Course_Glossary.html).
