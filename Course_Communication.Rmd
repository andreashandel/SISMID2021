...
**Note that SISMID set up a Slack workspace for the whole summer institute, with a channel for each Module. We decided that it's easier and more flexible if we have a separate workspace for this module. Thus, you might get invitations to 2 workspaces, the general SISMID one and the one for this module (called smi-course-2021). Join both. If you have not gotten an email invite to the Slack workspace SMI-Course-2021 the day before class starts, please let us know, either through the SISMID Slack channel or by email, so we can make sure everyone is part of the workspace for our course.**
